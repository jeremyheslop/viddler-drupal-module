...
/*##########	Video functions ########### */
	...
	*/
	...
	/ returns: array or xml
	/ doc: http://wiki.developers.viddler.com/index.php/Viddler.videos.delete
	*/
	...
	/ accepts: sessionid(number)
	/ returns: array or xml
	/ doc: http://wiki.developers.viddler.com/index.php/Viddler.videos.prepareUpload
	*/
	function video_prepareUpload($sessionid=null) {
		
		$result = $this->sendRequest('viddler.videos.prepareUpload', 'sessionid='.$sessionid);
		
		return $result;
	} // end video_prepareUpload()
